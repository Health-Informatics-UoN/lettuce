...
Some, like database credentials are still configured through the environment.
...
To use the UI, you have to do a little setup.

First, you have to choose what kinds of search you're going to enable.
