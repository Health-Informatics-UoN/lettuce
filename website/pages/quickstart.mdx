...
More details can be found in the [base_options documentation](/api_reference/options/base_options)
...
Prefer to have a graphical user interface? [You can do that, too!](./api_reference/ui.mdx)
