...
# Quickstart
The fastest way to get started with Lettuce is to use the [command-line interface (CLI)](/api_reference/lettuce/cli).
...
More details can be found in the [base_options documentation](/api_reference/lettuce/options/base_options)
...
## Next steps
Want to run a Lettuce server? [You can do that!](./deployment)

Prefer to have a graphical user interface? [You can do that, too!](/api_reference/lettuce-ui)
