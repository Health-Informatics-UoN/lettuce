...
The code for the server runs from [api.py](/api_reference/lettuce/api)
...
- `/health`: Reports that Lettuce is healthy and the version number
...
For more information, consult [the search routes documentation](/api_reference/lettuce/routers/search_routes.mdx)
