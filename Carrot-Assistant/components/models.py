...
local_models
-------------
    A dictionary of models that are stored locally. 
    
    The keys are the model names and the values are 
    dictionaries with the following keys. 
    
model_name and Information
---------------------------
...
# ---------------------------------------------------------- >
# ---------- Information about the local models ---------- >
...
"""               
    6. mistral-7b:
        ...
        - Description:
            Mistral 7B is highly optimized for efficiency and performance, often 
            outperforming models of larger sizes. 
...
# -------- Add more model information here -------- >
# ---------------------------------------------------------- >
...
def get_model(
    ...
    try:
        ...
        logger.error(f"An error occurred while loading the model {model_name}: {e}")
        raise ValueError(f"An error occurred while loading the model {model_name}: {e}")
